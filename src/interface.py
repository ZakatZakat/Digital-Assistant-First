...
def model_response_generator(retriever, model, config):
    ...
    "Текст должен быть сокращенным и лаконичным, но сохранять полный смысл оригинала. "
    "Избегайте повторений, сложных формулировок и ненужных деталей. "
    "Если текст состоит из нескольких предложений, объедините их в одно, сохраняя суть. "
