...
from src.offergen.agent import offer_matching_agent, RagDeps
from src.offergen import Offer, offers_db, db_service
from typing import Dict, List
from src.offergen.agent import PromptValidation
...
def get_system_prompt_for_offers(validation_result: PromptValidation, prompt: str) -> str:
    if not validation_result.is_valid:
        raise ValueError("Invalid request: " + validation_result.reason)
